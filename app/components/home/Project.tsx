...
// ${isIntersecting === 'SWITCH' ? 'even:translate-x-[100%] odd:anlate-x-[100%]' : 'even:-translate-x-[100%]'}
  return (
    <div
      ...
      />
      <div className={`w-full ${revealDetails === 'OPEN' ? 'h-full' : 'h-0'} bg-gradient-to-tr from-[rgba(0,0,0,0.6)] to-[#ff004f] rounded-[10px] absolute left-0 bottom-0 overflow-hidden flex items-center flex-col justify-center text-center px-10 text-sm z-30 duration-500 text-white`}>
